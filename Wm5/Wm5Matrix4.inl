...
//----------------------------------------------------------------------------
template <typename Real>
Matrix3<Real> Matrix4<Real>::TopLeft3x3 (void) const
{
    return Matrix3<Real>(
...
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Matrix4<Real>::GetColumnTop3 (int col) const
{
    return Vector3<Real>(mEntry[col], mEntry[col + 4], mEntry[col + 8]);
}
//----------------------------------------------------------------------------
template <typename Real>
Vector3<Real> Matrix4<Real>::GetRowLeft3 (int row) const
{
    return Vector3<Real>(mEntry[row * 4], mEntry[row * 4 + 1], mEntry[row * 4 + 2]);
}
//----------------------------------------------------------------------------
